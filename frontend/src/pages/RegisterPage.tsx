  ...
  return (
    <div className="min-h-screen flex bg-surface-primary">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-center p-12 overflow-hidden bg-surface-secondary">
        <div className="absolute inset-0 opacity-[0.03]" style={{ backgroundImage: "radial-gradient(circle at 1px 1px, var(--interactive-accent, #14B8A6) 1px, transparent 0)", backgroundSize: "40px 40px" }} />
