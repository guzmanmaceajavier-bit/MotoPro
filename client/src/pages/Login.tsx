    ...
    <div className="min-h-screen flex bg-surface-primary">
      <div className="hidden lg:flex lg:w-1/2 relative flex-col items-center justify-center p-12 overflow-hidden bg-[rgba(20,184,166,0.04)]">
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="mt-3 text-body text-text-tertiary max-w-sm">
            Tu taller de confianza. Accede a tu portal para gestionar vehículos, servicios y más.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
          ...
          <h1 className="text-h3 text-text-primary tracking-tight">Iniciar Sesión</h1>
          <p className="mt-2 text-body-sm text-text-tertiary">Accede a tu portal de cliente</p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-5">
            ...
            <p className="text-center text-tiny text-text-tertiary">
              ¿No tienes cuenta?{" "}
              <Link to="/register" className="text-interactive-accent hover:underline font-medium">Regístrate</Link>
            </p>
          </form>
        </motion.div>
      </div>
