    ...
    <main className="min-h-screen bg-surface-primary pt-28 pb-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          {loading ? (
            ...
            <EmptyState
              icon={<Heart className="w-8 h-8 text-text-tertiary" />}
              title="No tienes productos en favoritos"
              action={
                <Link to="/tienda" className="inline-block rounded-sm bg-interactive-accent px-6 py-3 text-body-sm font-semibold text-text-inverse hover:bg-interactive-accent-hover transition-colors">
                  Explorar tienda
                </Link>
              }
            />
