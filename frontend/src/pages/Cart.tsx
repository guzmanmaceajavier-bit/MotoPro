...
export default function Cart() {
  ...
  const suggestedProducts: SuggestedProduct[] = suggested.length > 0 ? suggested : [
                          ...
                          <div className="flex items-center justify-between mt-4">
                            <div className="flex items-center gap-2">
                              <button onClick={() => decrementItem(item.id)}
                                className="w-9 h-9 rounded-lg border border-border bg-surface-tertiary flex items-center justify-center text-text-secondary hover:text-text-primary hover:border-border-accent transition-all"
                              >
                                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h14" />
                                </svg>
                              </button>
                              <span className="w-10 h-9 flex items-center justify-center text-sm font-bold text-text-primary bg-surface-tertiary border border-border rounded-lg">
                                {item.quantity}
                              </span>
                  ...
                  {deliveryMode === "rastrear" && (
                    <div className="mt-4 space-y-4 pt-4 border-t border-border">
                      ...
                      <div className="p-4 rounded-xl bg-surface-tertiary border border-border">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-text-secondary">Contáctanos por WhatsApp</p>
                          </div>
                        </div>
                        <a
                      ...
                      <div className="p-4 rounded-xl bg-surface-tertiary border border-border">
                        ...
                        <a
                          href="mailto:servicio@motopro.com"
